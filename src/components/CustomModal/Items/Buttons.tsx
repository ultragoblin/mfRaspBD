...
import { EModalMode, ETabsNaming } from "../../../pages/Database/Database";
...
const Buttons = ({ tabNumber, mode, audModalData, groupModalData, subjectModalData, teacherModalData }: CustomModalButtonsProps) => {
  ...
  const handleClickSave = () => {
    switch (tabNumber) {
      case ETabsNaming.GROUPS:
        ...
        return mode === EModalMode.ADD ? putGroupAdm(data) : patchGroupAdm(data);
        break;
